...
/**
 * Accepts a pending teleport request for the executing player (as target).
 */
public class TpAcceptCommand implements CommandExecutor {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        if (!player.hasPermission("pitbullyplugin.tpaccept")) {
        ...
        player.sendMessage("§aTeleport-Anfrage angenommen.");
        return true;
    }
}
