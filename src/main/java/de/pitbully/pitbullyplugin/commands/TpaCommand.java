...
/**
 * Führt den /tpa Befehl aus.
 * <p>
 * Erwartet genau ein Argument (Zielspieler) und sendet diesem eine Teleport-Anfrage.
 * Die eigentliche Behandlung (Timeout, Annahme/Ablehnung) erfolgt in {@link TpaRequest}.
 */
public class TpaCommand implements CommandExecutor {

    /**
     * Handhabt den Aufruf von /tpa.
     *
     * Vertragsbedingungen:
    ...
    public boolean onCommand(@NotNull CommandSender commandSender,
        ...
        if (!player.hasPermission("pitbullyplugin.tpa")) {
        ...
        if (args.length != 1) {
            ...
            player.sendMessage("§eVerwendung: /tpa <Spieler>");
            return true;
        }
    ...
    if (args[0].equalsIgnoreCase(player.getName())) {
        ...
        new TpaRequest(player, targetPlayer).sendRequest();
